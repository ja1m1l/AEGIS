  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 overflow-hidden pt-24 md:pt-0">
      ...
      <div className="max-w-5xl z-20">
        <div className={`inline-flex items-center gap-2 px-5 py-2 rounded-full border mb-10 backdrop-blur-sm group cursor-pointer transition-all ${
        ...
        <h1 className={`text-4xl md:text-[7.5rem] font-medium tracking-tighter mb-8 leading-[0.9] transition-colors duration-700 ${isDark ? 'text-white' : 'text-black'}`}>
          ...
          <span className={`bg-gradient-to-r bg-clip-text text-transparent transition-all duration-700 ${
            isDark ? 'from-white via-white/80 to-white/40' : 'from-black via-black/80 to-black/40'
          }`}>Asset Defense</span>
        </h1>
        
        <p className={`text-sm md:text-xl max-w-2xl mx-auto mb-14 leading-relaxed font-light transition-colors ${
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button 
            ...
            className={`w-full sm:w-auto px-12 py-5 rounded-full font-black uppercase tracking-[0.2em] text-[11px] shadow-xl active:scale-95 transition-all ${
              isDark ? 'bg-white text-black hover:bg-gray-200 shadow-white/5' : 'bg-black text-white hover:bg-gray-800 shadow-black/10'
            }`}
          >
            Open Platform
          </button>
          <button 
            ...
            className={`w-full sm:w-auto px-12 py-5 rounded-full font-black uppercase tracking-[0.2em] text-[11px] border active:scale-95 transition-all ${
              isDark ? 'bg-transparent border-white/20 text-white hover:bg-white/10' : 'bg-transparent border-black/20 text-black hover:bg-black/5'
            }`}
          >
            Discover More
          </button>
