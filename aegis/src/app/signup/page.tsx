...
export default function SignUpPage() {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center px-4 py-8 transition-all duration-700 ${
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className={`p-8 rounded-[2.5rem] border backdrop-blur-3xl transition-all duration-500 ${
            ...
            <div className="mb-5">
              ...
              <div className="relative">
                <GraduationCap className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 ${
                  isDark ? 'text-gray-500' : 'text-gray-400'
                }`} />
                <input
                  type="text"
            ...
            <div className="mb-5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-12 py-3.5 rounded-2xl border transition-all duration-300 ${
                    isDark 
                      ? 'bg-white/5 border-white/10 text-white placeholder-gray-500 focus:border-indigo-500/50' 
                      : 'bg-gray-50 border-black/10 text-black placeholder-gray-400 focus:border-indigo-500/50'
                  }`}
            ...
            <div className="mb-6">
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  className={`w-4 h-4 rounded border transition-all mt-0.5 ${
